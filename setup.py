...
setup(
    ...
    project_urls={
        'Documentation': 'https://ogl_plot_data.readthedocs.io/',
        'Changelog': 'https://ogl_plot_data.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/ogl_plot_data/ogl_plot_data/issues',
    },
    keywords=[
